    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50 px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2">Join Sokogate and start sourcing today</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-300 text-white font-bold rounded-xl transition-colors flex items-center justify-center gap-2 mt-6"
            >
        ...
        <p className="mt-6 text-center text-sm text-slate-600">
          ...
          <Link to="/account/signin" className="text-blue-600 hover:text-blue-700 font-bold">
            Sign in
          </Link>
        </p>
